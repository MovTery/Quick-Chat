...
public class TransparentButton extends MouseClicksOnlyButton {
    ...
    protected void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.fill(this.getX(), this.getY() + this.getHeight(), this.getX() + this.getWidth(), this.getY(), color);

        pGuiGraphics.setColor(1.0F, 1.0F, 1.0F, 1.0F);
        int i = this.active ? 16777215 : 10526880;
        this.renderString(pGuiGraphics, minecraftClient.font, i | Mth.ceil(this.alpha * 255.0F) << 24);
    }

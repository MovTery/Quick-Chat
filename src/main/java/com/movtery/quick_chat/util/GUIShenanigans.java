...
public final class GUIShenanigans {
    /**
     * 参考 GUIShenanigans（https://github.com/Aizistral-Studios/No-Chat-Reports/blob/311bb9c/src/main/java/com/aizistral/nochatreports/common/gui/GUIShenanigans.java）
     */

        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable("quick_chat.config.anti_false_contact"))
                                .description(OptionDescription.of(Component.translatable("quick_chat.config.anti_false_contact.desc")))
